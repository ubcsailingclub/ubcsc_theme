        ...
        <div class="functionalPageContentOuterContainer">
            ...
            <div class="functionalPageContentContainer">
                <$control.Divs (designDivsBegin = "true")$>
                            ...
                            <div class="memberDetailsTabsContainer">
                                <$control.Divs (designDivsBegin = "true")$>
                                    <ul class="memberDetailsTabMenu">
                                        ...
                                        <$if (Model.UseTabTemplates)$>
                                        <li <$if (Model.IsRegistrationsTab)$> class="selected" id="registrationsShowLink"<$endif$>>
                                            <$if (Model.IsRegistrationsTab)$>
                                            <span id="ctl00_ContentArea_registrationsTabLabel"><$Model.Text.ProfileRegistrationsTab$></span>
                                            <$else$>
                                            <a href="<$Model.Urls.ProfileRegistrations$>" id="ctl00_ContentArea_registrationsTabLabel"><$Model.Text.ProfileRegistrationsTab$></a>
                                            <$endif$>
                                        </li>

                                        <li <$if (Model.IsInvoicesTab)$> class="selected" id="invoicesShowLink"<$endif$>>
                                            <div <$if (Model.ThereAreWarningOnInvoiceList)$> class="warning"<$endif$>>
                                                <$if (Model.IsInvoicesTab)$>
                                                <span id="ctl00_ContentArea_invoicesTabLabel"><$Model.Text.ProfileInvoicesTab$></span>
                                                <$else$>
                                                <a href="<$Model.Urls.ProfileInvoices$>" id="ctl00_ContentArea_invoicesTabLabel"><$Model.Text.ProfileInvoicesTab$></a>
                                                <$endif$>
                                            </div>
                                        </li>
                                        
                                        <$if (Model.DonationsEnabled)$>
                                        <li <$if (Model.IsDonationsTab)$> class="selected" id="donationsShowLink"<$endif$>>
                                            <$if (Model.IsDonationsTab)$>
                                            <span id="ctl00_ContentArea_donationsTabLabel"><$Model.Text.ProfileDonationsTab$></span>
                                            <$else$>
                                            <a href="<$Model.Urls.ProfileDonations$>" id="ctl00_ContentArea_donationsTabLabel"><$Model.Text.ProfileDonationsTab$></a>
                                            <$endif$>
                                        </li>
                                        <$endif$>
                                        <$else$>
                    ...
                    <$endif$>
                    <!-- end of member details tab container -->
                            ...
                            <$control.Divs (designDivsBegin = "true")$>
                                <div class="generalFieldsOuterContainer">
                                    ...
                                    <div class="generalFieldsContainer">
                                        <$if (Model.IsRegistrationsTab)$>
                                            <$control.Divs (designDivsBegin = "true")$>
                                            <$Registrations(Text=Model.MyRegistrationsTextResources)$>
                                            <$control.Divs (designDivsEnd = "true", ExtraClearEnd="true")$>
                                        <$endif$>
                                        <$if (Model.IsInvoicesTab)$>
                                            <$control.Divs (designDivsBegin = "true")$>
                    ...
                    <!-- end of member profile container -->
