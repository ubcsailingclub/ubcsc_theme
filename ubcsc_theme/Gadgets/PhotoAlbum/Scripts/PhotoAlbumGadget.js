(function ()
{
  if (!window.PhotoAlbumGadget)
  {
    window.PhotoAlbumGadget = {};
  }
  ...
  PhotoAlbumGadget.InitPhotoGallery = initPhotoGallery;
  PhotoAlbumGadget.InitJsFunctions = initJsFunctions;
  PhotoAlbumGadget.Page_Parsed = pageParsed;
  PhotoAlbumGadget.Page_Unloading = pageUnloading;
  PhotoAlbumGadget.CloseSaveAlbumDialog = closeSaveAlbumDialog;
  PhotoAlbumGadget.CloseUploadPhotosDialog = closeUploadPhotosDialog;
  PhotoAlbumGadget.Get_SaveAction = getSaveAction;
  PhotoAlbumGadget.Get_SaveTitle = getSaveTitle;
  PhotoAlbumGadget.Get_SaveDescription = getSaveDescription;
  PhotoAlbumGadget.Get_SaveButton = getSaveButton;
  PhotoAlbumGadget.Get_DeleteButton = getDeleteButton;
  PhotoAlbumGadget.Get_UploadButton = getUploadButton;
  PhotoAlbumGadget.Get_UploadAction = getUploadAction;
  PhotoAlbumGadget.ProcessingButton_OnClick = processingButtonClick;
  PhotoAlbumGadget.DeleteButton_OnClick = deleteButtonClick;
  PhotoAlbumGadget.UploadButton_OnClick = uploadButtonClick;
  PhotoAlbumGadget.SaveButton_OnClick = saveButtonClick;
  PhotoAlbumGadget.ImageMenu_OnMouseOver = imageMenuMouseOver;
  PhotoAlbumGadget.ImageMenu_OnMouseOut = imageMenuMouseOut;
  PhotoAlbumGadget.MenuButton_OnMouseOver = menuButtonMouseOver;
  PhotoAlbumGadget.MenuButton_OnMouseOut = menuButtonMouseOut;
  PhotoAlbumGadget.MenuButton_OnClick = menuButtonClick;
  PhotoAlbumGadget.NavigateToList = navigateToList;
  PhotoAlbumGadget.CheckLength = checkLength;
