(function ()
{
  ...
  PhotoAlbumSummaryGadget.ScrollBar = PhotoAlbumSummaryScrollBar;

  function PhotoAlbumSummaryScrollBar (renderGallery, gadgetContainer, rows, numberOfColumns, lengthThumbnails, buttonLeft, buttonRight)
  {
    var slider = gadgetContainer.querySelector('DIV[class="PhotoAlbumSummaryGadgetSlider"]'),
      scrollBar = gadgetContainer.querySelector('DIV[class="PhotoAlbumSummaryGadgetScrollBar"]'),
      scrollElement = gadgetContainer.querySelector('DIV[class="PhotoAlbumSummaryGadgetScrollElement"]');
    ...
    this.setImages = function(thumbnailsCount)
    {
        pThis.lengthThumbnails = thumbnailsCount;
    }
    ...
    function onMouseMove (event)
    {
      ...
      slider.setAttribute('class', 'PhotoAlbumSummaryGadgetSliderPress')
    }
    ...
    {
      realPositionSlider();
      slider.setAttribute('class', 'PhotoAlbumSummaryGadgetSlider');
